...
enum ModbusCommandRegAddr{
    ...
    READ_INTERFACE_CAR1_SPEED_CONTROL_ADDR=0,              //1 x速速         2 y速度      3 Z速度
    READ_INTERFACE_CAR2_SPEED_CONTROL_ADDR=0,              //1 x速速         2 y速度      3 Z速度
    READ_INTERFACE_CAR3_POSITION_CONTROL_ADDR=0,           //1 速度          2 位置类型    3 位置
    READ_INTERFACE_CAR4_SINGLE_SPEED_CONTROL_ADDR=0,        //1传送带1速度     2 传送带2速度 3 传送带3速度
    

    WRITE_CAR1_SPEED_ACK_TO_PAD_INTERFACE_ADDR=0,
    WRITE_CAR2_SPEED_ACK_TO_PAD_INTERFACE_ADDR=0,
    WRITE_CAR3_POSITION_ACK_TO_PAD_INTERFACE_ADDR=0,
    WRITE_CAR4_SINGLE_SPEED_ACK_TO_PAD_INTERFACE_ADDR=0,
    WRITE_CAR1_ODOM_ACK_TO_PAD_INTERFACE_ADDR=0,
    WRITE_ID_ACK_TO_PAD_INTERFACE_ADDR=0,
    WRITE_LASER_ACK_TO_PAD_INTERFACE_ADDR=0,
