...
#include <gohi_hw_rev_msgs/robot_state.h>
#include <gohi_hw_rev_msgs/roll_config.h>
#include <gohi_hw_rev_msgs/stair_config.h>
#include <gohi_hw_rev_msgs/idcard_read_config.h>
#include <gohi_hw_rev_msgs/idcard_write_config.h>
...
private:
	...
	//hardware resource
	gohi_hw_rev_msgs::robot_state robot_state;
	gohi_hw_rev_msgs::roll_config roll_vel_cmd_config_ ;
	gohi_hw_rev_msgs::stair_config stair_vel_cmd_config_;
			
	gohi_hw_rev_msgs::idcard_write_config idcard_write_config_;
