...
void HIGO_ROS::idcard_read_config_callback(const gohi_hw_rev_msgs::idcard_read_config& msg)
 {
 ...
 void HIGO_ROS::laser_range_read_config_callback(const gohi_hw_rev_msgs::sick_range& msg)
 {
