...
public:
    ...
    void setupUi(QWidget *datatablewindow)
    {
        ...
        datatablewindow->resize(814, 607);
        ...
        gridLayout_5->addWidget(chkBoxRowColor, 7, 1, 1, 1);
        ...
        gridLayout_5->addWidget(chkBoxHeaderH, 8, 0, 1, 1);
        ...
        gridLayout_5->addWidget(btnReadToEdit, 6, 0, 1, 2);
        ...
        gridLayout_5->addWidget(rBtnSelectItem, 9, 1, 1, 1);
        ...
        gridLayout_5->addWidget(chkBoxHeaderV, 8, 1, 1, 1);
        ...
        gridLayout_5->addWidget(rBtnSelectRow, 9, 0, 1, 1);
        ...
        gridLayout_5->addWidget(chkBoxTabEditable, 7, 0, 1, 1);
    ...
    void retranslateUi(QWidget *datatablewindow)
    {
        ...
        btnReadToEdit->setText(QApplication::translate("datatablewindow", "\350\257\273\345\217\226\350\241\250\346\240\274\345\206\205\345\256\271\345\210\260\346\226\207\346\234\254", nullptr));
