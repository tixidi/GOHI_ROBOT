...
#include <gohi_hw_sensor_msgs/robot_state.h>
#include <gohi_hw_sensor_msgs/roll_config.h>
#include <gohi_hw_sensor_msgs/stair_config.h>
...
private:
	...
	//hardware resource
	gohi_hw_sensor_msgs::robot_state robot_state;
	gohi_hw_sensor_msgs::roll_config roll_config ;
	gohi_hw_sensor_msgs::stair_config stair_config;
